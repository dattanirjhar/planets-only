...
OUTPUT_DIR = 'datasets'
OUTPUT_FILE = 'mega_unified_dataset_v2.csv'
...
def feature_engineering(df):
    """Creates new, physically meaningful features only if the required columns exist."""
    print("\n--- Performing Advanced Feature Engineering ---")
    
    # --- FIX START: Make feature creation fault-tolerant ---
...
def main():
    ...
    try:
        ...
        print("\n--- Training the Final XGBoost Champion Model on Enhanced Data ---")
