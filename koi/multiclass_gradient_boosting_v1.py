...
from sklearn.ensemble import GradientBoostingClassifier  # <-- The new model
...
try:
    ...
    # --- Step 2: Train the Multi-Class Gradient Boosting Classifier ---
    print("\n--- Training Multi-Class Gradient Boosting Classifier ---")
    X_train, X_test, y_train, y_test = train_test_split(
        X, y, test_size=0.3, random_state=42, stratify=y
    )

    # Here's the swap: we're using GradientBoostingClassifier now.
    # These models can be sensitive to n_estimators; 150 is a solid starting point.
    ...
    cm_path = os.path.join(output_dir, "gb_multiclass_confusion_matrix.png")
    plt.savefig(cm_path)
    plt.close()
    ...
    print("\nTop 10 Overall Most Important Features (Gradient Boosting):\n")
